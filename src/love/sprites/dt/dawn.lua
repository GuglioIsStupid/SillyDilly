...
return graphics.newSprite(
	love.graphics.newImage(graphics.imagePath("dt/dawn")),
	...
	},
	{
		...
		,
		["singDOWN"] = {start = 8, stop = 17, speed = 32, offsetX = -2, offsetY = -27},
		["singLEFT"] = {start = 38, stop = 47, speed = 32, offsetX = -5, offsetY = -5},
		["singRIGHT"] = {start = 28, stop = 37, speed = 32, offsetX = 8, offsetY = 5},
		["singUP"] = {start = 18, stop = 27, speed = 32, offsetX = 3, offsetY = 16},

		["idle"] = {start = 48, stop = 57, speed = 32, offsetX = 0, offsetY = 0},
		["singDODGE"] = {start = 1, stop = 7, speed = 24, offsetX = -3, offsetY = 5}
	},
	"idle",
	false,
    {
